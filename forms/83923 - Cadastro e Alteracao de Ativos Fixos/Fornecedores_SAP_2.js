function IntegracaoSAPFornecedores2() {
	...
	ajaxCall = $.ajax(settings).done(function(response) {
		...
		for(var i = 0; i < xmlLength; i++){
				var rslttipoFornec = $(this).find('BRSCH').eq(i).text();
		    ...
		    //Insert do XML Result em table HTML;modalTableFornecedores
				$("#modalTableFornecedores tbody").append("<tr><td>" + rsltNrFornec + "</td><td>" + rsltNameFornec + "</td><td>" + rsltCPFFornec + rsltCNPJFornec+"</td></tr>");
			}
		});
	});
}
